import 'package:anas_flutter_assignment/app_module/movie_detail/model/movie_detail_modal.dart';
import 'package:anas_flutter_assignment/utils/common_widgets/video_player.dart';
import 'package:anas_flutter_assignment/app_module/watch_movies_list/view/components/watch_movies_list_components.dart';
    ...
    child: Column(
      children: [
        ...
        Padding(
          ...
          child: AppButton(
            buttonName: AppStrings.GET_TICKET,
            ...
            onTap: () {
              Get.toNamed("/select_seat", arguments: [
                movieDetailController.movieDetail.value.title.toString(),
                AppStrings.THEATERS + "${formatDate(date.toString())}"
              ]);
            },
          ),
        ),
